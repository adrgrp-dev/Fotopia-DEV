...
function email($x,$y,$z)
{
 ...
 $mail->Body = "<html><head><style>.titleCss {font-family: \"Roboto\",Helvetica,Arial,sans-serif;font-weight:600;font-size:18px;color:#0275D8 }.emailCss { width:100%;border:solid 1px #DDD;font-family: \"Roboto\",Helvetica,Arial,sans-serif; } </style></head><table cellpadding=\"5\" class=\"emailCss\"><tr><td align=\"left\"><img src=\"".$_SESSION['project_url']."logo.png\" /></td><td align=\"center\" class=\"titleCss\">CREATED SuperCSR SUCCESSFUL</td><td align=\"right\">info@fotopia.com<br>343 4543 213</td></tr><tr><td colspan=\"2\"><br><br>";
...
<div class="col-md-12"><h5 align="center" adr_trans="label_create_editor"> Create Editor</h5></div>
	...
	<input id="email" name="email" placeholder="Email" type="email" autocomplete="off" onblur="validate_email(this.value)" class="form-control form-value" required="">
  							 ...
  							 <div class="col-md-6">
                                  ...
                                  <input id="contactno" name="contactno" placeholder="Contact number" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="8" autocomplete="off" class="form-control form-value" required="">
                              </div>
