   ...
   if($_SESSION["admin_loggedin_type"]='CSR')
    {
     ...
     { ?>
         <tr><td><?php echo $cnt; ?></td><td><?php echo'<a href='.$redirect.' style="color:#000;font-size:12px;">'.$get_action['module'].' '.  $get_action['action'].' by You </a>';?></td><td style="color:blue;font-size:12px;"><?php echo $date1; ?></td></tr>
                      <?php }
                       else {  ?>
