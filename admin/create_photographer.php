...
{
?>
 <button id="label_create" adr_trans="label_create" class="anima-button circle-button btn-sm btn" type="submit" name="signupbtn"><i class="fa fa-sign-in"></i>Create</button>&nbsp;&nbsp;<a id="label_cancel" adr_trans="label_cancel" class="anima-button circle-button btn-sm btn" href="csr_list1.php?fp=1"><i class="fa fa-times"></i>Cancel</a>
