...
<?php if(@$_REQUEST['first']) { ?><div class="col-md-12"><h4 align="center" id="label_add_company_profile" style="color:#006600!important;font-size:13px;">Step #6 of 7 : Create a Photographer</h5></div> <?php } ?>
