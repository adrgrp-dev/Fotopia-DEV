...
<div id="changePassword" class="box-lightbox white" style="color: #000;box-shadow: 5px 5px 5px 5px #aaa;background: #E8F0FE;padding:25px;height:300px; width:500px;border-radius:20px 20px 20px 20px">
				...
				<tr><td id="label_new_email" adr_trans="label_new_email">New Email</td><td>:</td><td><input type="email" name="newemail" id="newemail" class="form-control" value="<?php echo @$_SESSION['email_new']; ?>" required onblur="validate_email(this.value)" /></td></tr>
