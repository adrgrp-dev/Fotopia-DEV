                          ...
                          <div id="undefined-footer" class="bootgrid-footer container-fluid">
                            <div class="row"><div class="col-sm-6">
                              <ul class="pagination">
                                ...
                                <div class="col-sm-6 infoBar"style="margin-top:24px">
                                <div class="infos">
						<p align="right"><span adr_trans="label_showing">Showing</span> <?php echo $start_no_users+1; ?><span adr_trans="label_to">  to</span> <?php echo $cnt; ?> of <?php echo $total_no; ?><span adr_trans="label_entries">  entries</span></p>		
				<?php /* <p align="right">Showing <?php echo $start_no_users+1; ?> to <?php echo $cnt; ?> of <?php echo $total_no; ?> entries</p> */ ?>
								</div>
                                </div>
                              </div>
                            </div>
