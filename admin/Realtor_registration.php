...
<br><br>
<a href='{{project_url}}Realtor_approve.php?id={{id}}&profile_id={{profile_id}}&approve=1' class='button'>Ok</a>&nbsp;&nbsp;<a href='{{project_url}}Realtor_approve.php?id={{id}}&profile_id={{profile_id}}&approve=0' class='button'>Cancel</a>
<br><br>
