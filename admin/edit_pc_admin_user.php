...
function validate_email(val)
{
 ...
 <div class="col-md-12"><h5 align="center" id="label_edit_admin_user" adr_trans="label_edit_admin_user"> Edit Admin user</h5></div>
  						...
  						<div class="col-md-6">
                                  ...
                                  <input id="fname" name="fname" placeholder="First name" type="text" autocomplete="off" minlength="5" maxlength="20" class="form-control form-value" required="" value="<?php echo $pcAdmin['first_name']; ?>">
                              </div>
...
<div class="col-md-6">
	...
	<input id="email" name="email" placeholder="Email" type="email" autocomplete="off"   onblur="validate_email(this.value)" class="form-control form-value" required="" value="<?php echo $pcAdmin['email']; ?>">
  							 ...
  							 <div class="col-md-6">
                                  ...
                                  <input id="contactno" name="contactno" placeholder="Contact number" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" autocomplete="off" class="form-control form-value" required="" value="<?php echo $pcAdmin['contact_number']; ?>">
                              </div>
