...
<?php if(@$_REQUEST['first']) { ?><div class="col-md-12"><h5 align="center" id="label_add_company_profile" style="color:#006600!important;font-size:13px;">Welcome to Fotopia!<br />Step #1 of 7 : Fill out the Company profile</h5></div> <?php } ?>
						...
						<form name="profile" method="post" action="" enctype="multipart/form-data">
                               ...
                               <span style="margin-left:20px;color:red;display:none;font-size:9px;" id="Email_exist_error" align="center" class="alert-warning"></span>
                                ...
                                <input id="organization_number" name="organization_number" type="text" pattern="" autocomplete="off" class="form-control form-value"  required="" value="<?php echo @$res1['organization_number']; ?>">
								</div>
