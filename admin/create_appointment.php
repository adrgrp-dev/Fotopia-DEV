		...
		<a href="#">
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-4">
              ...
              <input id="plan" name="plan" placeholder="Enter The Floor Number " type="number" min="0"  autocomplete="off" class="form-control form-value" required="" value="<?php echo @$order_fetch['number_of_floor_plans']; ?>" <?php if(@$_REQUEST['edit']) { echo "readonly"; } ?>>
            </div>
            <div class="col-md-4">
