			 ...
			 <tr><th><span adr_trans="label_contact_no">contact Number</span></th><td>:</td><td style="word-break:break-all;"><?php echo $res1['contact_number']; ?></td></tr>
			  <tr><th><span adr_trans="label_address">Address</span></th><td>:</td><td style="word-break:break-all;"><?php echo $res1['address_line1'].", ".$res1['address_line2']; ?></td></tr>
			   <tr><th><span adr_trans="label_city">City</span></th><td>:</td><td><?php echo $res1['city']; ?></td></tr>
                ...
                <tr><th><span adr_trans="label_status">Status</span></th><td>:</td><td><?php $approved=$res1['is_approved']; if($approved==0) { echo "<span id='label_pending' adr_trans='label_pending' style='color: #000; font-weight: bold;display: block; background:#F58883;padding-top: 5px; max-width: 200px;padding-bottom: 5px;text-align: center;'>Pending</span>"; } elseif($approved==2) { echo "<span id='label_blocked' adr_trans='label_blocked' style='color: #000; font-weight: bold;display: block; background:#F58883;padding-top: 5px; max-width: 200px;padding-bottom: 5px;text-align: center;'>Blocked</span>"; } else { echo "<span id='label_approved' adr_trans='label_approved' style='color: #000; font-weight: bold;display: block; background:#76EA97;padding-top: 5px; max-width: 200px;padding-bottom: 5px;text-align: center;'>Approved</span>"; } ?></td></tr>
         ...
         <p align="center" style="margin-top:10px;">
				...
				<a id="label_approve" adr_trans="label_approve" class="anima-button circle-button adr-save btn-sm btn" href="pc_admin_details.php?approve=1&id=<?php echo $res1['id']; ?>"><i class="fa fa-check"></i>Approve</a> <?php }  else { ?>
								...
								?>
									...
									<a id="label_back_users_list" adr_trans="label_back_users_list" class="anima-button circle-button btn-sm btn adr-cancel" href="csr_list1.php"><i class="fa fa-sign-in"></i>Back to users list</a>
								<?php }
				if(@$_REQUEST['val'] == 1) {
					?>
