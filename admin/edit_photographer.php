						 ...
						 <div class="col-md-12"><h5 align="center" id="label_edit_photographer" adr_trans="label_edit_photographer"> Edit Photographer</h5></div>
  						...
  						<div class="col-md-6">
  							...
  							<div class="col-md-6">
                                  ...
                                  <input id="lname" name="lname" placeholder="Last name" type="text" autocomplete="off" class="form-control form-value" required="" value="<?php echo $csr['last_name']; ?>">
                              </div>
...
{
?>
<button id="label_update" adr_trans="label_update"  class="anima-button circle-button btn-sm btn" type="submit" name="signupbtn"><i class="fa fa-sign-in"></i>Update</button>&nbsp;&nbsp;<a id="label_cancel" adr_trans="label_cancel" class="anima-button circle-button btn-sm btn" href="csr_list1.php"><i class="fa fa-times"></i>Cancel</a>
