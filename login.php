		...
		<div class="coverflow-slider">
             ...
             <br>
                        ...
                        <div class="error-box"  style="display:block;">
                            ...
                            adr_trans=""><i style="color: #ff3300;">Your Email ID is not verified.</i></div>
                            <div class="text-danger" id="label_notified_approved" adr_trans=""><i style="color: #ff3300;">Please click to verify your Email Id in gmail account.</i></div>
                        </div>
						<?php } ?>
